...
export const images = {
  ...
  "about": {
    ...
    alt: "Dr. Sarah Bennett consulting with a patient",
    width: 1200,
    height: 800,
  },
  ...
  "service-1": {
    ...
    alt: "Preventative dental care tools",
    width: 1200,
    height: 800,
  },
  ...
  "cta": {
    ...
    alt: "Modern dental office architecture",
    width: 1200,
    height: 800,
  },
  ...
  "testimonial-bg": {
    src: "https://images.unsplash.com/photo-1579684385127-1ef15d508118?q=80&w=1200&auto=format&fit=crop",
    alt: "Bright Smile Dental Office Exterior",
    width: 1200,
    height: 800,
  },
} as const;
